								...
								<div class="table-responsive">
									<table id="example2" class="table">
										...
										<?php $no=1; foreach($result->result() as $r){?>
											<tr>
												<td><?php echo $no; ?></td>
												<td><?php echo $r->user_full_name; ?></td>
                                                <td><?php echo $r->user_email; ?></td>
                                                <td><?php echo $r->user_phone; ?></td>
                                                <td><?php echo $r->user_role; ?></td>
                                                <td><a href="<?php echo site_url()?>backoffice/<?php echo $modul;?>/edit/<?php echo md5($r->user_id);?>"><i class="fa fa-pencil"></i></a> <a class="col-md-offset-1" onclick="confirm_deleted(<?php echo $r->user_id; ?>);"><i class="fa fa-trash"></i></a></td>
											</tr>
                                        <?php $no++;} ?>
										</tbody>
									</table>

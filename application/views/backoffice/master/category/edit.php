				...
				<div class="row">
					<div class="col-md-12 col-sm-12 col-xs-12">
						<div class="section">
							<div class="section-body">
								<div class="row">
									<form class="validate-form" action="<?php echo site_url()?>backoffice/<?php echo $modul;?>/edit/<?php echo md5($result->category_id);?>" method="POST">
										<div class="col-md-12 col-sm-12 col-xs-12">
											<div class="form-group">
												<label class="col-md-2 margin-t-xs">Nama Kategori:</label>
												<div class="col-md-10 margin-b-sm">
													<input class="form-control" type="text" id="name" value="<?php echo $result->category_name?>" name="name" placeholder="Masukan Nama">
												</div>
											</div>
											<div class="form-group">

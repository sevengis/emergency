								...
								<div class="table-responsive">
									<table id="example2" class="table">
										...
										<?php $no=1; foreach($result->result() as $r){?>
											<tr>
												<td><?php echo $no; ?></td>
												<td><?php echo $r->service_point_name; ?></td>
                                                <td><?php echo $r->service_point_lat; ?>,<?php echo $r->service_point_lng; ?></td>
                                                <td><img src="<?php echo base_url();?>assets/upload/compressed/"><?php echo $r->info_point_file; ?></td>
                                                <td><a href="<?php echo site_url()?>backoffice/<?php echo $modul;?>/edit/<?php echo md5($r->service_point_id);?>"><i class="fa fa-pencil"></i></a> <a class="col-md-offset-1" onclick="confirm_deleted(<?php echo $r->service_point_id; ?>);"><i class="fa fa-trash"></i></a></td>
											</tr>
                                        <?php $no++;} ?>
										</tbody>
									</table>
